    ...
    (function() {
        ...
        this.getElementCSSPath = function(element)
        {
            ...
            if(paths.length){
                ...
                if(byIDIndex){
                    return paths.slice(byIDIndex).join(" ")
                }
			
                var notOnlyTypeIndex = null;
                ...
                if(notOnlyTypeIndex && notOnlyTypeIndex>1){
                    return paths.slice(notOnlyTypeIndex).join(" ")
                }
        ...
        this.getElementCSSSelector = function(element)
        {
            ...
            if(["html","body","center","tbody"].indexOf(label) > -1)
                return null
            if (element.id)
                label += "#" + element.id;
            if (element.hasAttribute("class"))
                ...
                label += "[name='" + element.getAttribute("name").split(" ")[0]+"']";
            else if (element.hasAttribute("type"))
                label += "[type='" + element.getAttribute("type").split(" ")[0]+"']";
            return label;
        };
